...
import SpaceError from '../errors/parse-map-illegal-space.js'
import NameError from '../errors/parse-map-name-not-string.js'
import KeyError from '../errors/parse-map-key-not-string.js'
/**
